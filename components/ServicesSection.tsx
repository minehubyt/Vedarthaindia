        ...
        <div className="container mx-auto px-6 lg:px-[8vw] max-w-[1800px]">
                ...
                >
                  ...
                  <div className="absolute inset-0 z-10 p-10 flex flex-col justify-between">
                    <div>
                      ...
                      <h4 className="text-2xl font-black mb-4 tracking-tighter group-hover:text-white transition-colors">
          ...
          >
            <div className="max-w-xl">
              <h3 className="text-3xl font-bold mb-4 tracking-tight">Ready to transform?</h3>
              <p className="text-gray-400 font-light text-lg">Partner with our global specialists to achieve measurable results.</p>
            </div>
